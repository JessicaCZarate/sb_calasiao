...
const Services = () => {
  ...
  return (
    <section className="h-auto pb-12 relative justify-center items-center flex flex-col">
      ...
      <div className="absolute pointer-events-none pattern-boxes pattern-green-300 pattern-bg-white pattern-opacity-10 pattern-size-6 top-2 left-0 right-0 bottom-0"></div>
        ...
        {serviceItems.map((serviceItem, index) => {
          return (
            <div
              ...
              <h5 className="mb-1 text-lg sm:text-xl font-bold text-gray-900 group-hover:text-white dark:text-white tracking-wide">
                {serviceItem.text}
              </h5>
            </div>
          );
