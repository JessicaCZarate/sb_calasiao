      ...
      {map.map((item, index) => (
        <figure
          ...
          className={`flex flex-col hover:bg-yellow-300 p-8 text-center bg-white border-b border-gray-200 ${
            index === 0
              ? "rounded-t-lg rounded-b-none md:rounded-l-lg md:rounded-t-none md:rounded-ss-lg"
              : "rounded-t-none rounded-b-lg md:rounded-r-lg md:rounded-b-none md:rounded-se-lg"
          } md:border-e`}>
