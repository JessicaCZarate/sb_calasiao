...
export default function Example() {
  ...
  return (
    <div className="relative bg-blend-multiply bg-gray-500 bg-[url('https://images.unsplash.com/photo-1505820013142-f86a3439c5b2?q=80&w=1471&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center bg-no-repeat">
      ...
      <div className="relative isolate px-6 py-32 pt-14 lg:px-8">
        <div
          aria-hidden="true"
        ...
        <div className="mx-auto max-w-2xl">
          {/* <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-200 ring-1 ring-gray-100/10 hover:ring-gray-900/20">
